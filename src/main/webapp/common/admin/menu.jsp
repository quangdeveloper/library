...
<div class="bg-light border-right" id="sidebar-wrapper">
    <div class="sidebar-heading"><span><i class="fa fa-bookmark" aria-hidden="true" style="color: #007bff"></i></span>  Tổng Quan</div>
    <div class="list-group list-group-flush">
        ...
        <a href="#" class="list-group-item list-group-item-action bg-light">
            ...
            Giảng viên</a>
        <a href="/admin/accounts" class="list-group-item list-group-item-action bg-light">
