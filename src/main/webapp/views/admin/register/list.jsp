...
<c:url var="DELETEAPI" value="/v1/api/admin/registers"></c:url>
<c:url var="URL" value="/v1/admin/registers?pageNo=1&pageSize=10"></c:url>
<c:url var="URLCHANGE" value="/v1/admin/registers/add"></c:url>
<c:url var="URLSearch" value="/v1/admin/registers/search"></c:url>
<c:url var="URLPagination" value="/v1/admin/registers"></c:url>
